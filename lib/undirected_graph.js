...
UndirectedGraph = (function() {
  ...
  UndirectedGraph.prototype.addEdge = function(r1, r2) {
	...
	/*if(typeof this.graph[r2] == "undefined")
		this.graph[r2] = new Set();
	if(typeof this.graph[r1] == "undefined")
		this.graph[r1] = new Set();*/
  ...
  UndirectedGraph.prototype.slColorize = function() {
	...
	UndirectedGraph.prototype.bruteColorize = function(){
			...
			var colorsUsed = 1;
			for(nowVertex = 2; nowVertex <= this.size ; nowVertex++){
				this.b_colors[nowVertex] = 1;
				
				while(this.hasConflict(nowVertex)){
					this.b_colors[nowVertex]+=1;	
				}
				if(this.b_colors[nowVertex] > colorsUsed)
					colorsUsed = this.b_colors[nowVertex];
			}
    ...
    UndirectedGraph.prototype.hasConflict = function(vertex)
    {
		for(n = 1; n <= this.size; n++){
			...
			if(typeof this.graph[n][vertex] != "undefined" && typeof this.b_colors[n] != "undefined" && this.b_colors[n] == this.b_colors[vertex])
				return true;
		}
		return false;
    };
